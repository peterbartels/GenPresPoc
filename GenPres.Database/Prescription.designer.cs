...
namespace GenPres.Database
{
	...
	[System.Data.Linq.Mapping.DatabaseAttribute(Name="GenPres")]
    ...
    partial void OnDrugConcentrationChanged();
		...
		[Column(Storage="_DrugId", DbType="Int NOT NULL")]
		public int DrugId
		{
			get
			{
		...
		[Column(Storage="_ComponentName", DbType="NVarChar(MAX)")]
		...
		[Column(Storage="_IsSolution", DbType="Bit")]
		...
		[Column(Storage="_SolutionRelation", DbType="Float")]
		...
		[Association(Name="Component_Substance", Storage="_Substances", ThisKey="Id", OtherKey="ComponentId")]
		...
		[Association(Name="UnitValue_Component1", Storage="_UnitValue1", ThisKey="DrugConcentration", OtherKey="Id", IsForeignKey=true)]
    ...
    partial void OnRateChanged();
		...
		[Column(Storage="_PrescriptionId", DbType="Int NOT NULL")]
		...
		[Association(Name="UnitValue_Dose1", Storage="_UnitValue1", ThisKey="Total", OtherKey="Id", IsForeignKey=true)]
		public UnitValue UnitValue1
		{
			get
			{
		...
		[Association(Name="UnitValue_Dose2", Storage="_UnitValue2", ThisKey="Rate", OtherKey="Id", IsForeignKey=true)]
    ...
    partial void OnQuantityChanged();
		...
		[Column(Storage="_Shape", DbType="NVarChar(MAX)")]
		public string Shape
		{
			get
			{
		...
		[Column(Storage="_Route", DbType="NVarChar(MAX)")]
		public string Route
		{
			get
			{
		...
		[Column(Storage="_SolutionType", DbType="NVarChar(MAX)")]
		...
		[Association(Name="Drug_Component", Storage="_Components", ThisKey="Id", OtherKey="DrugId")]
		public EntitySet<Component> Components
		{
			get
			{
		...
		[Association(Name="Drug_Prescription", Storage="_Prescriptions", ThisKey="Id", OtherKey="DrugId")]
		public EntitySet<Prescription> Prescriptions
		{
			get
			{
		...
		[Association(Name="UnitValue_Drug", Storage="_UnitValue", ThisKey="Quantity", OtherKey="Id", IsForeignKey=true)]
		public UnitValue UnitValue
		{
			get
			{
    ...
    partial void OnQuantityChanged();
		...
		[Column(Storage="_GenericName", DbType="NVarChar(MAX)")]
		...
		[Column(Storage="_ShapeName", DbType="NVarChar(MAX)")]
		...
		[Column(Storage="_RouteName", DbType="NVarChar(MAX)")]
		...
		[Column(Storage="_ComponentIncrement", DbType="Int")]
		...
		[Column(Storage="_DoseIncrement", DbType="Int")]
		...
		[Association(Name="Medicine_Prescription", Storage="_Prescriptions", ThisKey="Id", OtherKey="MedicineId")]
		public EntitySet<Prescription> Prescriptions
		{
			get
			{
		...
		[Association(Name="UnitValue_Medicine", Storage="_UnitValue", ThisKey="ComponentIncrement", OtherKey="Id", IsForeignKey=true)]
		public UnitValue UnitValue
		{
			get
			{
		...
		[Association(Name="UnitValue_Medicine1", Storage="_UnitValue1", ThisKey="DoseIncrement", OtherKey="Id", IsForeignKey=true)]
		public UnitValue UnitValue1
		{
			get
			{
		...
		[Association(Name="UnitValue_Medicine2", Storage="_UnitValue2", ThisKey="Quantity", OtherKey="Id", IsForeignKey=true)]
		public UnitValue UnitValue2
		{
			get
			{
    ...
    partial void OnPIDChanged();
		...
		[Column(Storage="_MedicationWeight", DbType="Float")]
		...
		[Column(Storage="_PID", DbType="NVarChar(MAX)")]
		public string PID
		{
			get
			{
		...
		[Association(Name="Patient_Prescription", Storage="_Prescriptions", ThisKey="Id", OtherKey="PatientId")]
		public EntitySet<Prescription> Prescriptions
		{
			get
			{
    ...
    partial void OnMedicineIdChanged();
		...
		[Column(Storage="_Continuous", DbType="Bit")]
		...
		[Column(Storage="_Infusion", DbType="Bit")]
		...
		[Column(Storage="_Onrequest", DbType="Bit")]
		...
		[Column(Storage="_Solution", DbType="Bit")]
		...
		[Column(Storage="_IsTemplate", DbType="Bit")]
		...
		[Column(Storage="_TPN", DbType="Bit")]
		...
		[Column(Storage="_AdjustLength", DbType="Int")]
		...
		[Column(Storage="_AdjustWeight", DbType="Int")]
		...
		[Column(Storage="_DrugId", DbType="Int")]
		...
		[Column(Storage="_MedicineId", DbType="Int")]
		...
		[Association(Name="Prescription_Dose", Storage="_Doses", ThisKey="Id", OtherKey="PrescriptionId")]
		public EntitySet<Dose> Doses
		{
			get
			{
		...
		[Association(Name="UnitValue_Prescription1", Storage="_UnitValue1", ThisKey="Quantity", OtherKey="Id", IsForeignKey=true)]
		public UnitValue UnitValue1
		{
			get
			{
		...
		[Association(Name="UnitValue_Prescription2", Storage="_UnitValue2", ThisKey="Total", OtherKey="Id", IsForeignKey=true)]
		public UnitValue UnitValue2
		{
			get
			{
		...
		[Association(Name="UnitValue_Prescription3", Storage="_UnitValue3", ThisKey="Rate", OtherKey="Id", IsForeignKey=true)]
		...
		[Association(Name="UnitValue_Prescription4", Storage="_UnitValue4", ThisKey="Time", OtherKey="Id", IsForeignKey=true)]
		...
		[Association(Name="UnitValue_Prescription5", Storage="_UnitValue5", ThisKey="AdjustLength", OtherKey="Id", IsForeignKey=true)]
		...
		[Association(Name="UnitValue_Prescription6", Storage="_UnitValue6", ThisKey="AdjustWeight", OtherKey="Id", IsForeignKey=true)]
    ...
    partial void OnPassCryptChanged();
		...
		[Column(Storage="_PassCrypt", DbType="VarChar(32)")]
