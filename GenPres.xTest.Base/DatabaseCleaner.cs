...
";
        ...
        {
            using (var session = GenPresApplication.SessionFactory.OpenSession())
            {
        ...
        {
            return new StringBuilder().AppendFormat(EmptyAllTables, "GenPresTest", "1").ToString();
        }
        ...
        private static string RestoreSystemAdminSql()
        {
            ...
            sql.AppendFormat(
                @"INSERT INTO [GenPresTest].[dbo].[User]
           ([Id]
           ,[Version]
           ,[Name]
           ,[Email]
