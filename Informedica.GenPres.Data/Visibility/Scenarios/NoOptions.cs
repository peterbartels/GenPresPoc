...
{
    public class NoOptions : IScenario
    {
        private readonly Prescription _prescription;
        private readonly PrescriptionDto _prescriptionDto;

        public NoOptions(Prescription prescription, PrescriptionDto prescriptionDto)
        {
        ...
        public PropertyVisibilityConfig[] PropertyVisibility
        {
            get
            {
                ...
                return new[]
                {
                    ...
                    new PropertyVisibilityConfig(true, _prescriptionDto.adminTotal),
                    new PropertyVisibilityConfig(true, _prescriptionDto.doseTotal),
