...
{
    public class PatientSqlRepository : SqlRepository<IPatient, Database.Patient>, IPatientSqlRepository
    {
        ...
        internal PatientSqlRepository(IDataContextManager context)
            : base(context)
        {
            _patientMapper = new PatientMapper(DataContextManager);
        }
