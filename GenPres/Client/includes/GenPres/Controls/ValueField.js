...
ValueField = Ext.extend(Ext.Container, {
    ...
    initComponent: function() {
        ...
        if (typeof (this.formContainer) != "undefined") {
            ...
            this.spinner.on("blur", function(obj) {
                ...
                this.formContainer.UpdateForm(obj);
            } .createDelegate(this));
        ...
        if (this.unitStore) {
            ...
            if (typeof (this.formContainer) == "object"){
                this.unitCombo.on("select", this.formContainer.UpdateForm);
                this.unitCombo.on("blur", this.formContainer.UpdateForm);
        ...
        if (this.totalUnits) {
            ...
            if (typeof (this.formContainer) == "object") this.totalSelect.on("select", this.formContainer.UpdateForm);
            if (typeof (this.formContainer) == "object") this.totalSelect.on("blur", this.formContainer.UpdateForm);
        ...
        if (this.adjustUnitStore) {
            ...
            if (typeof (this.formContainer) == "object") this.adjustSelect.on("select", this.formContainer.UpdateForm);
            if (typeof (this.formContainer) == "object") this.adjustSelect.on("blur", this.formContainer.UpdateForm);
        ...
        if (this.timeUnitStore) {
            ...
            if (typeof (this.formContainer) == "object") this.timeSelect.on("select", this.formContainer.UpdateForm);
            if (typeof (this.formContainer) == "object") this.timeSelect.on("blur", this.formContainer.UpdateForm);
    ...
    getValue: function() {
		...
		if(result.Value > 0) result["State"] = this.state;
