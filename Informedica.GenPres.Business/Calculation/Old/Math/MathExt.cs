...
namespace Informedica.GenPres.Business.Calculation.Old.Math
{
    public static class MathExt
    {
        ...
        {
            decimal result = System.Math.Round(a, 0, MidpointRounding.ToEven);
        ...
        {
            decimal result = System.Math.Floor(a);
            if (result < 1) result = 1;
            return result;
        }
        ...
        {
            decimal result = System.Math.Ceiling(a);
            if (result < 1) result = 1;
            return result;
        }
        ...
        {
            return System.Math.Round(number, 6);
        }
        ...
        {
            a = System.Math.Round(a, 6);
            b = System.Math.Round(b, 6);
            return (decimal)(a % b);
        }
